...
namespace
{
    SingleChainDefinition createArmDefinition(const MString& side)
    {
        ...
        chain.bones =
        {
            { "clavicle", MVector(2.0  * direction, 22.0,  0.0), 1.6 },
            { "shoulder", MVector(3.0  * direction, 22.0,  0.0), 1.6 },
            { "elbow",    MVector(8.0  * direction, 22.0, -0.5), 1.4 },
            { "wrist",    MVector(12.0 * direction, 22.0,  0.0), 1.2 }
        };
    ...
    TreeBoneDefinition createHandDefinition(const MString& side)
    {
        ...
        {
            "palm",
            MVector(13.0 * direction, 22.0, 0.0),
            1.2
        };
        handChain.children =
        {
            createFingerChain(
                ...
                "thumb",
                {
                    { "thumb_01", MVector(13.6 * direction, 22.0, 0.4), 0.5 },
                    { "thumb_02", MVector(14.1 * direction, 22.0, 0.5), 0.5 },
                    { "thumb_03", MVector(14.6 * direction, 22.0, 0.5), 0.5 },
                }
            ),
            createFingerChain(
                handChain,
                "index",
                {
                    { "index_01", MVector(14.2 * direction, 22.0, 0.2), 0.5 },
                    { "index_02", MVector(14.8 * direction, 22.0, 0.2), 0.5 },
                    { "index_03", MVector(15.2 * direction, 22.0, 0.2), 0.5 },
                }
            ),
            createFingerChain(
                handChain,
                "mid",
                {
                    { "mid_01", MVector(14.5 * direction, 22.0, 0.0), 0.5 },
                    { "mid_02", MVector(15.1 * direction, 22.0, 0.0), 0.5 },
                    { "mid_03", MVector(15.5 * direction, 22.0, 0.0), 0.5 },
                }
            ),
            createFingerChain(
                handChain,
                "ring",
                {
                    { "ring_01", MVector(14.4 * direction, 22.0, -0.2), 0.5 },
                    { "ring_02", MVector(15.0 * direction, 22.0, -0.2), 0.5 },
                    { "ring_03", MVector(15.4 * direction, 22.0, -0.2), 0.5 },
                }
            ),
            createFingerChain(
                handChain,
                "pinky",
                {
                    { "pinky_01", MVector(14.2 * direction, 22.0, -0.4), 0.5 },
                    { "pinky_02", MVector(14.8 * direction, 22.0, -0.4), 0.5 },
                    { "pinky_03", MVector(15.2 * direction, 22.0, -0.4), 0.5 },
                }
            )
        };
    ...
    SingleChainDefinition createLegDefinition(const MString& side)
    {
        ...
        chain.bones =
        {
            { "thigh", MVector(1.5 * direction, 14.0, 0.0), 1.6 },
            { "knee",  MVector(1.5 * direction, 7.0, 0.5), 1.3 },
            { "ankle", MVector(1.5 * direction, 1.0, 0.0), 1.1 },
            { "ball",  MVector(1.5 * direction, 0.5, 2.0), 1.0 },
            { "toe",   MVector(1.5 * direction, 0.5, 3.5), 0.8 }
        };
    ...
    SingleChainDefinition createSpineDefinition()
    {
        ...
        chain.bones =
        {
            {"pelvis",   MVector(0.0, 14.0, 0.0), 2.5},
            {"spine_01", MVector(0.0, 17.0, 0.4), 1.9},
            {"spine_02", MVector(0.0, 19.0, 0.4), 1.5},
            {"chest",    MVector(0.0, 22.0, 0.0), 1.8}
        };
    ...
    SingleChainDefinition createHeadDefinition()
    {
        ...
        chain.bones =
        {
            { "neck", MVector(0.0, 23.0, 0.0), 1.5 },
            { "head", MVector(0.0, 26.0, 0.0), 1.8 }
        };
